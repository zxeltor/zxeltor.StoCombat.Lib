...
public static class CombatLogParserResultExtensions
{
    ...
    public static CombatLogParserResult AddMessage(this CombatLogParserResult thisResult, string? message,
        ResultLevel resultLevel = ResultLevel.Info)
    {
    ...
    public static CombatLogParserResult MergeResult(this CombatLogParserResult thisResult,
        CombatLogParserResult appendResult)
    {
